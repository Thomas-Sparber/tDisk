...
int tdisk_operation(struct td_device *device, int direction, sector_t start, u8 *buffer, unsigned int length, void (*callback)(void*,unsigned int,int), void *callback_data);
