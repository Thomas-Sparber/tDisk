	...
	if(outputFormat == "json")
		return utils::concat(
			"{\n",
				...
				std::vector<char>(hierarchy+1, '\t'), CREATE_RESULT_STRING_NONMEMBER_JSON(used, hierarchy+1, outputFormat), ",\n",
		...
		return utils::concat(
				...
				CREATE_RESULT_STRING_NONMEMBER_TEXT(used, hierarchy+1, outputFormat), "\n",
