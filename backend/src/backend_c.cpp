...
C_FUNCTION_IMPLEMENTATION(add_disk)
C_FUNCTION_IMPLEMENTATION(remove_disk)
...
C_FUNCTION_IMPLEMENTATION(get_debug_info)
...
C_FUNCTION_IMPLEMENTATION(tdisk_pre_remove)
